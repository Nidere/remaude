...
5. Relay: Lightsail (free tier первые 3 месяца, дальше ~3.5–5 $/мес — согласовано) + Caddy + `remaude.nidere.com` (Route53), Google OAuth + whitelist, пейринг хостов.
6. Мультихост, агрегация проектов, индикаторы состояния/непрочитанного, виджет лимитов.
7. PWA + Web Push.
